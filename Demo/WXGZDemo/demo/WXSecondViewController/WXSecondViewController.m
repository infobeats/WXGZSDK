...
//    self.navigationController.navigationItem.titleView = btn1;
...
- (void)addLeftItem {
    ...
    [btn setTitle:@" 返回1" forState:UIControlStateNormal];
...
//    UIBarButtonItem *rightItem3 = [[UIBarButtonItem alloc] initWithTitle:@"k加载" style:UIBarButtonItemStylePlain target:self action:@selector(clickItem2)];
    ...
    self.navigationItem.rightBarButtonItems = @[back,back2];
